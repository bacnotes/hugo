...
雖然sitemap現在擷取上好像卡住了，不過在文章數相對少的狀況下  
還有一種方式可以呼叫爬蟲來爬取這些頁面  

### 使用Google Search Console的要求建立索引  
有時候寫完一篇文章，希望可以盡早被爬蟲爬取建立索引  
因為部落格我是自架的所以產出sitemap與更新sitemap自己可以處理  
但如果是行銷人員可能就不一定這麼方便  
...
點下方的要求建立索引，就會跟Google提交要求建立索引進入排程  
