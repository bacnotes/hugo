...
如果還沒看過 [JavaScript 基礎知識複習(1)](https://bacnotes.github.io/p/javascript-fundamentals-part1/ "JavaScript基礎知識複習(1)｜The Complete JavaScript Course")  
可以看完上一篇，再回來繼續閱讀唷！
...
還有很多其他的 array 方法，可以參考這篇 [陣列的處理方法](https://bacnotes.github.io/p/array-methods/ "陣列的處理方法") 
