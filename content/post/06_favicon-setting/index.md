...
通常檔名會是favicon.ico，但隨著瀏覽器的優化也開始支援png、gif、svg檔  
...
有的只有3種尺寸，相對有限  
這家還提供了[Favicon checker](https://realfavicongenerator.net/favicon_checker#.YcroKBNBxd1 "Favicon checker")讓你檢測你的網站favicon在各個瀏覽器的現狀
...
(中間有一個Resoc Social Image Automation，看起來應該是推廣自家產品用的)   
